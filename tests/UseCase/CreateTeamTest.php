...
use App\Infrastructure\Symfony\Command\Team\CreateTeamCommand;
...
class CreateTeamTest extends KernelTestCase
{
    ...
    public function setUp(): void
    {
        ...
        // Supprime toute équipe existante avec le nom 'RCSA' pour éviter les doublons
        $existingTeam = $this->em->getRepository(Team::class)->findOneBy(['name' => 'RCSA']);
        if ($existingTeam) {
            $this->em->remove($existingTeam);
            $this->em->flush();
        }
